export const PeoData = {
  img: require("../../images/about-uscopy.png"),
  ...
  vid1: require("../../videos/PEO+Services.mov"),
  ...
  header1: "UAE PEO Services",
  data1:
    "We help businesses onboard and payroll employees across the GCC and MENA region. With legal entities in Dubai, Abu Dhabi, Saudi Arabia, Qatar, Kuwait, Bahrain, Egypt and partners in over 45+ countries we can quickly mobilize staff identified by our customers through our global mobility platform at cost effective pricing.",
...
export const HrOutData = {
  img: require("../../images/hr_service-01.jpeg"),
  head: "HR OUTSOURCING",
  header:
    "Nathan & Nathan is a leading HR Outsourcing provider in the UAE and KSA",
  poster: require("../../images/posters/HROutsourcing.png"),
  vid1: require("../../videos/intro.mp4"),
...
export const StaffingData = {
  ...
  header:
    "Nathan & Nathan is a leading HR Outsourcing provider in the UAE and KSA",
  vid1: require("../../videos/Staffing+Services.mov"),
  data: "Staffing solutions built to offer organizations expertise and flexibility as they need it. Our experienced recruiters deliver talent through our digital staffing platform to help your business identify great candidates to fill positions faster. We offer staffing solutions to over 95+ industries and place candidates in diverse roles ranging from executive to senior level positions.",
  header1: "Temporary Staffing",
  data1:
    "Organizations leverage our temporary staffing solution to hire talent for shorter contract periods to fill roles on a temp basis or as a trial prior to offering longer term employment opportunities. Nathan & Nathan holds special manpower licensing from the ministry of labor to offer temporary staff deployed under our visa and labor card for short term requirements to our clients",
...
export const RemoteWorkData = {
  ...
  header:
    "Nathan & Nathan is a leading HR Outsourcing provider in the UAE and KSA",
  vid1: require("../../videos/remote-workforce.mp4"),
  data: "Employ talent globally with our remote workforce solutions",
  noextra: "true",
  header1: "Remote Technology & IT Staff",
  data1:
    "Hire talent remotely to drive your software development, cyber security, and other IT requirements. Access expert talent from major offshoring regions with all the sourcing and employee management handled and taken care of.",
...
export const ExpertConsultData = {
  ...
  header:
    "Nathan & Nathan is a leading HR Outsourcing provider in the UAE and KSA",
  vid1: require("../../videos/expert-consulting.mp4"),
  data: "Unleash your companies full potential with easy access to global consultants",
  header1: "Expert Consultant Deployment",
  data1:
    "Access expert consultants with industry specific experience to help advise on projects across your business. Combining consultants with internal teams can lead to preferred outcomes and minimizes the risk of project delays. From ERP Implementation to brand Development, operations optimization and more, our talent sourcing team and pool of over 3,500+ vetted consultants in the region, we can help you find the right person to help get the job done.",
